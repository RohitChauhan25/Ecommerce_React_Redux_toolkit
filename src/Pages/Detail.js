                ...
                <div className='row'>

                    {
                        relatedProducts.map((items) => {
                            return <>
                                <div key={items.id} className="col-lg-3 col-md-4 col-sm">

                                    <div className="card product-item border-0 mb-4">
                                        <div className="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                                            <img className="img-fluid w-100" src={items.image} alt="" style={{ height: "300px" }} />
                                        </div>
                                        <div className="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                            <h6 className="text-truncate mb-3">{items.title}</h6>
                                            <div className="d-flex justify-content-center">
                                                <h6>${items.price}</h6><h6 className="text-muted ml-2"><del>$123.00</del></h6>
                                            </div>
                                        </div>
